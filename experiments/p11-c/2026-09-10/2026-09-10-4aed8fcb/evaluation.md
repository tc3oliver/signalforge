...
Run: `unknown`  ·  Evaluated: 2026-09-13T09:43:19.555Z
Overall: **PASS**
...
- `important_story_recall`: 10/11 important gold events reached the brief; missed: evt-20260910-arc-model-rumor-d1
...
- `change_type_accuracy`: 14/16 matched stories carry the expected changeType; wrong: basalt-engine-revenue-share-rumor: NEW != RUMOR; meridian-long-context-enterprise-model: NEW != RUMOR
