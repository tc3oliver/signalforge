...
Run: `unknown`  ·  Evaluated: 2026-09-13T09:23:36.498Z
Overall: **PASS**
...
- `cluster_precision`: TP=72, predicted pairs=72, gold pairs=73 (noise items excluded)
- `cluster_recall`: TP=72, predicted pairs=72, gold pairs=73 (noise items excluded)
- `cluster_f1`: TP=72, predicted pairs=72, gold pairs=73 (noise items excluded); precision=1.000, recall=0.986
- `change_type_accuracy`: 15/15 matched stories carry the expected changeType; wrong: none
